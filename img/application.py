...
def rekog():
    if request.method == 'POST':
        ...
        if rekog_info == '[][]':
            return '{"results":"text not detected"}'
        else:
...
if __name__ == '__main__':
    ...
    image1 = "https://raw.githubusercontent.com/ed-chin-git/ed-chin-git.github.io/master/m50_contrast.JPG"
    image2 = ""
    rekog_info = post_rekog({"image_locations": [image1, image2]})

    print(query_from_rekog(post_rekog({"image_locations": [image1, image2]})))
